...
const Contact = ({ data, editMode, onUpdate }) => {
  ...
  const onSubmit = (formData) => {
    ...
    const message = `Halo! Saya tertarik dengan layanan Web3 Anda.
...
Mohon informasi lebih lanjut. Terima kasih!`;
    ...
    const whatsappNumber = '6281365368638'; // +62 813-6536-8638
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            Ready to start your Web3 journey? Let's discuss your project and build something amazing together.
          </p>
        </motion.div>
                ...
                {data.phone && (
                  <div className="flex items-center space-x-4">
                    <div className="w-12 h-12 bg-secondary-100 dark:bg-secondary-900 rounded-lg flex items-center justify-center">
                      <PhoneIcon className="h-6 w-6 text-secondary-600 dark:text-secondary-400" />
                    </div>
                    <div>
                  ...
                  {socialLinks.map((social) => (
                    social.url && (
                      <a
                        ...
                        className="w-12 h-12 bg-gray-100 dark:bg-gray-700 hover:bg-primary-100 dark:hover:bg-primary-900 rounded-lg flex items-center justify-center transition-colors group"
                      >
              ...
              <div className="flex items-center justify-center mb-6">
                <div className="text-center">
                  ...
                  <div className="flex items-center justify-center space-x-2 text-green-600 dark:text-green-400">
                    ...
                    <span className="text-sm">Langsung terhubung ke WhatsApp</span>
                  </div>
                </div>
              </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  value={editData.social?.discord || ''}
                  onChange={(e) => setEditData({ 
                    ...editData, 
                    social: { ...editData.social, discord: e.target.value }
                  })}
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                />
              </div>
